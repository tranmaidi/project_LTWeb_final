    ...
    <body>
                                    ...
                                    <tbody id="content">
                                        <c:forEach items="${listAllInvoice}" var="i">
                                            <tr>
                                                ...
                                                <c:set var="isFound" scope="request" value="false"/>
                                                
                                                <c:forEach items="${listAllPayment}" var="p">
                                                    <c:if test="${continueExecuting}">
                                                        <c:choose> 
                                                        
                                                            <c:when test="${i.maHD == p.maHD && p.phuongThuc == 'Chuyển khoản qua ngân hàng'}">
                                                                <td>${p.phuongThuc}</td>
                                                                ...
                                                                <c:set var="isFound" scope="request" value="true"/>
                                                            </c:when>       
        ...
        <script>
            function searchByDate(param) {
                ...
                $.ajax({
                    url: "/WebsiteBanGiay_last1/searchAjaxHoaDon",
