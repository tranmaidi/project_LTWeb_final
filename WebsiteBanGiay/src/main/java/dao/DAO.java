...
public class DAO {
    ...
    public List<History> getTop10SanPhamBanChay() {
        ...
        String query = "SELECT TOP 10 productID, SUM(amount) AS totalSold\n" +
                        "FROM History\n" +
                        "GROUP BY productID\n" +
    ...
    public List<Customer> getTop5KhachHang() {
        ...
        String query = "SELECT TOP 5 accountID, SUM(tongGia) AS totalSpent\n" +
                        "FROM Invoice\n" +
                        "GROUP BY accountID\n" +
...
//    }
    ...
    {
        int result = -1;
        String query = "select top 1 * from Invoice \r\n"
                + "order by [maHd] Desc";
        try{
...
//    public History checkHistoryExist(int accountID,int productID) {
//
...
//           rs = ps.executeQuery();
//           while (rs.next()) {
//               return new History(rs.getInt(1),
//                        rs.getInt(2),
//                        rs.getInt(3),
//                        rs.getString(4),
//                        rs.getInt(5),
...
//
    ...
    public void insertPayment(int maHD, int accountID, double tongGia, String phuongThuc) {
        String query = "insert into Payment(maHD,accountID,amount,phuongThuc)\r\n"
                + "values(?,?,?,?)";
